...
CONFIG.USE_RESET {false} \
  ...
  connect_bd_net -net Clk_4_Div_0_Clk_2Mhz [get_bd_ports Clk_2Mhz] [get_bd_pins Clk_4_Div_0/Clk_2Mhz] [get_bd_pins adc_0/clk_2Mhz]
  connect_bd_net -net MISO_1 [get_bd_ports MISO] [get_bd_pins adc_0/MISO]
  connect_bd_net -net adc_0_MOSI [get_bd_ports MOSI] [get_bd_pins adc_0/MOSI]
  connect_bd_net -net adc_0_SCK [get_bd_ports SCK] [get_bd_pins adc_0/SCK]
  connect_bd_net -net adc_0_adc_reset [get_bd_ports adc_reset] [get_bd_pins adc_0/adc_reset]
  connect_bd_net -net adc_0_raw_data [get_bd_ports raw_data] [get_bd_pins adc_0/raw_data]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins adc_0/reset]
