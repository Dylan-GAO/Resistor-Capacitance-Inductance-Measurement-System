...
#
# Generated by Vivado on Mon Dec 04 15:52:44 +0800 2017
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../ADC_SPI_test.srcs/sources_1/bd/system/ipshared/9c7f" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../ADC_SPI_test.srcs/sources_1/bd/system/ipshared/9c7f" \
