...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib dist_mem_gen_v8_0_11)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RCIMS_bd.wdb xsim.dir)
