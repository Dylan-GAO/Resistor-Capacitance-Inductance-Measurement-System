...
HD_PWD='c:/work/resistor-capacitance-inductance-measurement-system/rcims/rcims.tmp/dds_v1_0_project/DDS_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDS_v1_0.tcl
