...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "grey_RGB" -parent ${Page_0}
...
proc update_PARAM_VALUE.grey_RGB { PARAM_VALUE.grey_RGB } {
	# Procedure called to update grey_RGB when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.grey_RGB { PARAM_VALUE.grey_RGB } {
	# Procedure called to validate grey_RGB
	return true
}
...
proc update_MODELPARAM_VALUE.grey_RGB { MODELPARAM_VALUE.grey_RGB PARAM_VALUE.grey_RGB } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.grey_RGB}] ${MODELPARAM_VALUE.grey_RGB}
}
