...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../lcd_test.srcs/sources_1/bd/top/ip/top_lcd_display_0_0/sources_1/bd/system/ipshared/9c7f" \
       +incdir+"../../../../lcd_test.srcs/sources_1/bd/top/ip/top_lcd_display_0_0/sources_1/bd/system/ipshared/9c7f"
}
