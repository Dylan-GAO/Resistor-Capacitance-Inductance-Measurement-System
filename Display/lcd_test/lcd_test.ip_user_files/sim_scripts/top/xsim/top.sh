...
xv_path="D:/Shared_Softwares/Xilinx/Vivado/2017.2"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L dist_mem_gen_v8_0_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top xil_defaultlib.top xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Shared_Softwares/Xilinx/Vivado/2017.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
