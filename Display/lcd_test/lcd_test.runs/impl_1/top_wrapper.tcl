...
set rc [catch {
  ...
  add_files -quiet C:/Users/Administrator/Documents/GitHub/Resistor-Capacitance-Inductance-Measurement-System/Display/lcd_test/lcd_test.runs/synth_1/top_wrapper.dcp
...
set rc [catch {
  ...
  catch {file copy -force debug_nets.ltx top_wrapper.ltx}
